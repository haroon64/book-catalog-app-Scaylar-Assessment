    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-xl p-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 mt-2">Join us to manage your books</p>
        </div>
        ...
        <div className="space-y-6">
          ...
          {/* Email Input */}
           <div>
            ...
            } text-black rounded-lg focus:ring-2 focus:ring-indigo-500`}
            placeholder="Enter your full name"
        />
             {errors.name && (
            <span className="text-xs text-white bg-red-500 px-2 py-1 rounded mt-1 inline-block">
            {errors.name}
            </span>
        )}
          </div>
          <div>
            ...
            <input
              ...
              className="w-full px-4 text-black py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
